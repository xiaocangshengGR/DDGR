...
class TrainLoop:
    ...
    def run_loop(self):
        ...
        while (
            ...
            all_loss = self.run_step(batch, cond)
    ...
    def run_step(self, batch, cond):
        all_loss = self.forward_backward(batch, cond)
    ...
    def save(self,best_flag=False):
        ...
        if best_flag:
            ...
            if dist.get_rank() == 0:
                with bf.BlobFile(
                    bf.join(self.exp_dir, "opt000000.pt"),
                    "wb",
                ) as f:
                    th.save(self.opt.state_dict(), f)
